...
# 2. Modelo Pydantic (com campo obrigatório novo)
...
@app.get("/")
def raiz():
    return {"mensagem": "API do Laboratório Maker operante. Acesse /docs"}
